...
MenuAdministrador::MenuAdministrador(std::string title, Session *session, MenuOpcoesUsuario *menuOpcoesUsuario, MenuCadastroPendente *menuCadastroPendente, MenuCadastros *menuCadastros, ControllerEscolheModalidade *controllerEscolheModalidade) : Menu(title), _session(session), _menuOpcoesUsuario(menuOpcoesUsuario), _menuCadastroPendente(menuCadastroPendente), _controllerEscolheModalidade(controllerEscolheModalidade)
{
  inicializarOpcoes();
}
